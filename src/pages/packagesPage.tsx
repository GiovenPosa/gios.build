...
export function PackagesPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Packages — gios.build | Web Design Services & Website Pricing</title>

        <meta
          name="description"
          content="Choose from simple, effective web design packages at gios.build — from starter one-page sites to full lead-generation systems with integrations, analytics, and SEO foundations."
        />

        <meta
          name="keywords"
          content="web design packages, website pricing uk, small business website, website redesign, lead generation website, web design services, landing page design, gios.build"
        />

        <link rel="canonical" href="https://www.gios.build/packages" />
      </Helmet>
